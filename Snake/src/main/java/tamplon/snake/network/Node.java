package tamplon.snake.network;

import tamplon.snake.network.message.MessageFactory;
import tamplon.snake.gamelogic.GameModel;
import tamplon.snake.gamelogic.gamefield.Direction;
import tamplon.snake.gamelogic.snake.Steerable;
...
import tamplon.snake.gamelogic.gameobjects.player.Player;
import tamplon.snake.gamelogic.event.EventChannel;
import tamplon.snake.gamelogic.event.EventProcessor;
import tamplon.snake.gamelogic.event.HandlerDescriptor;
import tamplon.snake.gamelogic.event.events.IncomingMessage;
import tamplon.snake.gamelogic.event.events.NodeTimedOut;
import tamplon.snake.gamelogic.event.events.OutgoingMessage;
...
import tamplon.snake.gamelogic.snake.impl.LocalSnake;
import tamplon.snake.util.Constants;
import tamplon.snake.util.Scheduler;
...
import static tamplon.snake.util.Constants.ANNOUNCE_DELAY_MS;
import static tamplon.snake.util.Constants.announceAddress;
...
public final class Node
{
            ...
            final AddressedMessage message) throws InterruptedException
    {
        synchronized (this.lock)
        {
            ...
            this.gameModel.setState(GameState.fromMessage(stateMessage.getState()));
